...
Thats it! If some things are not fully clear yet, try having a look at the [demo projects](https://github.com/Dr0f0x/ChainCLI/tree/v1.0.0-alpha/demo) or dive deeper into the detailed API-Reference.